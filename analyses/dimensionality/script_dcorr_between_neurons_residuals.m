...
%%% compute pairwise distance correlations
    ...
    save('./results/dcorrs_pairwise_resids.mat', 'dcorrs');
...
%%% compute pairwise Pearson correlations
    ...
    save('./results/corrs_pairwise_resids.mat', 'corrs');


%%% plot figure
    load('./results/dcorrs_pairwise_resids.mat');
    load('./results/corrs_pairwise_resids.mat');
    
    f = figure;
    plot(corrs, dcorrs, '.');
    
    saveas(f, './figs/dcorrs_vs_corrs_resids.pdf');
